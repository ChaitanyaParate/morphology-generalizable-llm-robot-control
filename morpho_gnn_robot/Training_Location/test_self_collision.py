...
obs, info = env.reset()
action = np.ones(12) * 0.5 # A relatively large action
...
for contact in contacts:
    ...
    if bodyB == env._robot_id:
        print(f"SELF COLLISION: link {linkIndexA} touched link {linkIndexB}")
    else:
        print(f"GROUND COLLISION: link {linkIndexA}")
